    ...
    def _initialize_patterns(self):
        ...
        self.pattern_sets: Dict[int, Dict[str, Dict[int, float]]] = {
            ...
            0: {
                ...
                'snare': {4: 1.0, 12: 1.0},
                'hihat': {i: 0.5 for i in range(self.MAX_STEPS)},
            ...
            3: {
                'kick': {i: 0.9 for i in range(0, self.MAX_STEPS, 4)},
                'snare': {4: 1.0, 12: 1.0},
                'hihat': {i: (0.7 if i % 4 == 0 else 0.4) for i in range(self.MAX_STEPS)},
                'crashcymbal': {0: 0.8, 8: 0.6},
            },
            # Pattern 4: Breakbeat
            4: {
                'kick': {0: 1.0, 6: 0.7, 10: 0.8, 14: 0.6},
                'snare': {4: 1.0, 11: 0.6, 13: 0.8},
                'hihat': {i: (0.6 if i % 2 == 0 else 0.4) for i in range(self.MAX_STEPS)},
                'hightom': {2: 0.7, 8: 0.75},
            },
        }
