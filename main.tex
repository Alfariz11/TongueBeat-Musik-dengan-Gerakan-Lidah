...
\usepackage{lmodern} % <-- PERBAIKAN 1: Ditambahkan untuk font scalable
...
\subsection{Code Snippets}
    ...
    \begin{lstlisting}[language=Python, caption=Captionnya tulis di sini class,label=labelkode] % <-- PERBAIKAN 2: label={labelkode} diubah
